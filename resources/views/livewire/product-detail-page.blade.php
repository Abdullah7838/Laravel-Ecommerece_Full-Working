    ...
    <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
      <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ $product->imageUrls[0] ?? asset('storage/products/default.jpg') }}' }">
            <div class="sticky top-0 z-50 overflow-hidden ">
              ...
              <div class="flex-wrap hidden md:flex">
                ...
                @foreach ($product->imageUrls as $index => $imageUrl)
                
                  <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ $imageUrl }}'">
                    <img src="{{ $imageUrl }}" alt="{{ $product->name }}" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
                  </div>
            ...
            <div class="lg:pl-20">
              <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4">
                ...
                <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                  ...
                  {{-- <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">PKR 1800.99</span> --}}
                </p>
